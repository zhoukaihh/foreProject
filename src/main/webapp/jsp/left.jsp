		...
		<dd>
			...
			<ul class="menuson">
				<auth:hasRole token="${loginType}" role="admin">
					<li><cite></cite><a
						href="${pageContext.request.contextPath}/roles/getAllRole.action "
						target="rightFrame">角色管理</a><i></i></li>
					<li><cite></cite><a
						href="${pageContext.request.contextPath}/pers/findPersPage.action"
				...
				<li><cite></cite><a href="${pageContext.request.contextPath}/orders/findOrdersByPage.action?pageNo=1" target="rightFrame">订单管理</a><i></i></li>
				<li><cite></cite><a
					href="${pageContext.request.contextPath}/behaviour/findBehavioursByPage.action?pageNo=1" target="rightFrame">角色行为查看</a><i></i></li>
				<li><cite></cite><a
