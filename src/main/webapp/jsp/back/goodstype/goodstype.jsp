...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li><span><a href="${pageContext.request.contextPath}/goodTypes/getFirst"/><img src="images/t01.png" /></span>添加</a></li>
        <li class="click"><span><img src="images/t02.png" /></span>修改</li>
        <li><span><img src="images/t03.png" /></span>删除</li>
        <li><a href="${pageContext.request.contextPath}/jsp/back/charts/goodstypecharts.jsp"><span><img src="images/t04.png" /></span>统计</a></li>
        </ul>
        <ul class="toolbar1">
    ...
    <table class="tablelist">
        ...
        <tbody>
       			<tr>
			        ...
			        <td>
			        	<a href="${pageContext.request.contextPath}/goodTypes/update?secondTypeId=${goodsType.secondTypeId}">编辑</a> |
			        	<a href="${pageContext.request.contextPath}/goodTypes/delete?secondTypeId=${goodsType.secondTypeId}&pageNo=${currentpage}">删除</a>
			        </td>
		        </tr> 
        </tbody>
        </c:forEach>
