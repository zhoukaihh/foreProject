...
<body>
	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<ul class="toolbar">
				<li class="click"><a href="${pageContext.request.contextPath}/goods/findParent"><img
						src="images/t01.png" align="middle" />添加</a></li>
				<li class="click"><span><img src="images/t02.png" /></span>修改</li>
				<li><span><img src="images/t03.png" /></span>删除</li>
				<li><a href="${pageContext.request.contextPath}/jsp/back/charts/goodscharts.jsp"><span><img src="images/t04.png" /></span>统计</a></li>
			</ul>
				...
				<c:forEach items="${goods}" var="goodsInfo">
					<tr>
						...
						<td><a
							...
							href="${pageContext.request.contextPath}/goods/delete?goodId=${goodsInfo.goodId}&pageNo=${currentpage}"
				...
				<div style="text-align: center;">
					<div
						...
						<c:if test="${currentpage>1}">
						   <a href="${pageContext.request.contextPath}/goods/list?pageNo=${currentpage-1}"
						   			style="text-decoration: none">上一页</a>
                                        </c:if> 
                        
                        <c:if test="${currentpage < allPage}">                
						<a href="${pageContext.request.contextPath}/goods/list?pageNo=${currentpage+1}"
								style="text-decoration: none">下一页</a></c:if>
