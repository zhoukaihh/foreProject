			...
			<tbody id="tbody">
				<c:forEach items="${goods}" var="goodsInfo">
					<tr>
						...
						<td>${goodsInfo.gDes}</td>
						<td align="center"><img src="${pageContext.request.contextPath}/images/${goodsInfo.gPhoto}"
							style="width: 120px; height: 90px;" align="middle" /></td>
						<td>${goodsInfo.gcPrice}</td>
						<td><a
							href="${pageContext.request.contextPath}/goods/findGoodById.action?gId=${goodsInfo.gId}&pageNo=${currentpage}"
							class="tablelink">编辑</a> <a
							href="${pageContext.request.contextPath}/goods/deleteGoodById.action?gId=${goodsInfo.gId}&pageNo=${currentpage}"
				...
				<div style="text-align: center;">
					<div
						...
						<a href="${pageContext.request.contextPath}/goods/findGoodsByPage.action?pageNo=1"
