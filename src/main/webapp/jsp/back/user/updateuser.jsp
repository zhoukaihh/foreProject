...
<body>
	...
	<div class="formbody">
		...
		<form
			...
			<ul class="forminfo">
				<li><label>用户名</label><input name="loginName" type="text"
					class="dfinput" value="${user.loginName}" /></li>
				<li><label>密码</label><input name="password" type="text"
					class="dfinput" value="${user.password}" /></li>
				<li><label>电话</label><input name="telNum" type="text"
					class="dfinput" value="${user.telNum}" /></li>
				...
				<li><label>性别</label> <select name="gender" class="dfinput">
						<option value="null"
							<c:if test="${user.loginName eq 'null'}">selected="selected"</c:if>>请选择</option>
						<option value="男"
							<c:if test="${user.loginName eq '男'}">selected="selected"</c:if>>男</option>
						<option value="女"
							<c:if test="${user.loginName eq '女'}">selected="selected"</c:if>>女</option>
				</select></li>
