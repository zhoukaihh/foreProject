...
<body>
    ...
    <form method="post" action="${pageContext.request.contextPath}/ads/update?pageNo=${pageNo}" enctype="multipart/form-data">
	    ...
	    <li><label>商品图片</label>
	     	<img id="img" src="${pageContext.request.contextPath}/shoppingImages/${ad.imgPath}" width="100px" height="100px" />
