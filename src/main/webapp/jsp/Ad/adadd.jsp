...
<body>
    ...
    <div class="formtitle"><span>添加广告信息</span></div>
    <form action="${pageContext.request.contextPath}/ads/addAd.action" method="post" enctype="multipart/form-data">
    	<ul class="forminfo">
	    <li><label>广告类型</label><input name="adType" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
	     <li><label>广告图片</label>
