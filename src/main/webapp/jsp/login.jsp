		...
		<div class="login-main">
			...
			<div class="login-box">
				...
				<div class="login-form">
					<form  method="post" id ="login_from" action="${pageContext.request.contextPath}/login">
						<div class="user-name">
							<label for="user"><i class="am-icon-user"></i></label> <input
								type="text" name="loginName" id="loginName" placeholder="邮箱/手机/用户名">
						</div>
						<div class="user-pass">
							<label for="password"><i class="am-icon-lock"></i></label> <input
								type="password" name="password" id="password" placeholder="请输入密码">
								<!-- 区别前后端登录的hidden -->
								<input type="hidden" name="webpagetype" value="front"/>
						</div>
